...
echo "==> micro-os CI: building optional programs (curl, ifconfig, ping, dig, nslookup, zip, unzip, zlib, xz, bzip2, less, awk, traceroute, whois, uptime, ps, pkill, fastfetch)"
GROUP=optional scripts/build-programs.sh curl ifconfig ping bind-dns-tools zip unzip zlib xz bzip2 less awk traceroute whois uptime ps pkill fastfetch
